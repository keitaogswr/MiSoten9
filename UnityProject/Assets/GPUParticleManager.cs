...
public class GPUParticleManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //computeShader.SetVector("_Position", new Vector4(250,0,0,1));
        //computeShader.SetVector("_Velocity", Quaternion.identity * velocity);
        //DispatchEmit(emitGroupNum);
    ...
    void DispatchUpdate()
    {
        ...
        computeShader.SetTexture(updateKernel_, "_CameraDepthTexture", Gbuffer.GetDepthTexture());
        computeShader.SetTexture(updateKernel_, "_CameraGBufferTexture2", Gbuffer.GetGBufferTexture(2));
