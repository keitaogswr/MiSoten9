...
public class Snow : MonoBehaviour {
    ...
    {
        var target_position = GameObject.Find("Player/Capsule/PlayerCamera").transform.TransformPoint(Vector3.forward * range_);
        ...
        mr.material.SetVector("_CamUp", GameObject.Find("Player/Capsule/PlayerCamera").transform.up);
        mr.material.SetVector("_Range", target_position);
        float x = 0f;
        float y = -2f;
        float z = 0f;
