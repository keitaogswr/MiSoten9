...
public class titeleScript01 : MonoBehaviour {
	...
	void Start () {
        ...
        TitleLogo = GameObject.Find("Title_Canvas01/UI_title_0");
        SubTitleLogo = GameObject.Find("Title_Canvas01/UI_title_1");
        PushBtn = GameObject.Find("Title_Canvas01/UI_title_2");
